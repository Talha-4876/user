...
//
// Props:
//   selected       : string  — current selected method id
//   onChange       : fn(methodId) — callback
//   methods        : array (optional) — override default list
//   walletNumber   : string
//   onWalletChange : fn(value)
//   cardNumber     : string
//   cardExpiry     : string
//   cardCVV        : string
//   cardName       : string
//   onCardChange   : fn(field, value)
//   errors         : object { walletNumber, cardNumber, cardExpiry, cardCVV, cardName }
