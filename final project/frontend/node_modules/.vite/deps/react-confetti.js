...
import { t as require_jsx_runtime } from "./jsx-runtime-BrKinwle.js";

//#region node_modules/tween-functions/index.js
var require_tween_functions = /* @__PURE__ */ __commonJS({ "node_modules/tween-functions/index.js": ((exports, module) => {
	var tweenFunctions = {
...
var ParticleShape;
(function(ParticleShape$1) {
	ParticleShape$1[ParticleShape$1["Circle"] = 0] = "Circle";
	ParticleShape$1[ParticleShape$1["Square"] = 1] = "Square";
	ParticleShape$1[ParticleShape$1["Strip"] = 2] = "Strip";
})(ParticleShape || (ParticleShape = {}));
var RotationDirection;
(function(RotationDirection$1) {
	RotationDirection$1[RotationDirection$1["Positive"] = 1] = "Positive";
	RotationDirection$1[RotationDirection$1["Negative"] = -1] = "Negative";
...
var ParticleGenerator = class {
	constructor(canvas, getOptions) {
		...
		this.animate = (elapsed) => {
			const { canvas: canvas$1, context, particlesGenerated, lastNumberOfPieces } = this;
			...
			if (debug) {
				...
				context.fillText(`Particles: ${nP}`, canvas$1.width - 10, canvas$1.height - 20);
			}
			for (let i = this.particles.length - 1; i >= 0; i--) {
				const p = this.particles[i];
				p.update(elapsed);
				if (p.y > canvas$1.height || p.y < -100 || p.x > canvas$1.width + 100 || p.x < -100) if (recycle && activeCount <= numberOfPieces) this.particles[i] = this.getParticle();
...
var Confetti = class {
	constructor(canvas, opts) {
		...
		this.setOptionsWithDefaults = (opts$1) => {
			this._options = {
				confettiSource: {
					x: 0,
					y: 0,
			...
			Object.assign(this, opts$1.confettiSource);
		};
		this.update = (timestamp = 0) => {
			const { options: { run, onConfettiComplete, frameRate }, canvas: canvas$1, context } = this;
...
var ReactConfetti = import_react.forwardRef((props, ref$1) => (0, import_jsx_runtime.jsx)(ReactConfettiInternal, {
	canvasRef: ref$1,
	...props
}));
